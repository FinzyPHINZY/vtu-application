            ...
            {isMobileView ? (
                <div className='min-h-screen w-full bg-black pt-7 pb-10 px-16 max-sm:px-7 flex flex-col justify-between'>
                    <div className='flex justify-between items-center'>
                        ...
                        <p className='text-white font-[400] text-base font-poppins'>Change transaction pin</p>
                        <div></div>
                    </div>
                    ...
                    <p className='text-[#FF3D00] text-center my-3 font-[400] text-base font-poppins'>Reset Transaction PIN</p>
